...
class UnetMask(nn.Module):
    ...
    def forward(self,input):
        ...
        # print(".................", input_img.shape,".....", input_pose.shape)
        #feat extract
...
class PATNetwork(nn.Module):
    ...
    def forward(self, input):
        if self.gpu_ids and isinstance(input[0].data, torch.cuda.FloatTensor):
            ...
            return final_image, bg_fill, out_mask, out_img, target_bg, target_image_fg
        else:
