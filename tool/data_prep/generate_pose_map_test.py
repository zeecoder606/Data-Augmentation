...
MISSING_VALUE = -1
# fix PATH
img_dir  = 'seed_data/test' #raw image pathK
annotations_file = 'seed_data/seed-annotation-test.csv' #pose annotation path
save_path = 'seed_data/testK' #path to store pose maps
