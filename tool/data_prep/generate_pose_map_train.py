...
MISSING_VALUE = -1
# fix PATH
img_dir  = 'seed_data/train' #raw image path
annotations_file = 'seed_data/seed-annotation-train.csv' #pose annotation path
save_path = 'seed_data/trainK' #path to store pose maps
