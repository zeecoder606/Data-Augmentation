...
MISSING_VALUE = -1
# fix PATH
img_dir  = 'market_seed_data/test' #raw image path
annotations_file = 'market_seed_data/market-seed-annotation-test.csv' #pose annotation path
save_path = 'market_seed_data/testK' #path to store pose maps

# img_dir  = 'market_seed_data/train' #raw image path
# annotations_file = 'market_seed_data/market-seed-annotation-train.csv' #pose annotation path
# save_path = 'market_seed_data/trainK' #path to store pose maps
